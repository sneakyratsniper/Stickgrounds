...
#player.add(Player())
'''
camera = Camera(player_1,player_2)
follow = Follow(camera,player_1,player_2)
border = Border(camera,player_1,player_2)
auto = Auto(camera,player_1,player_2)
...
def hp_bar():
  ...
  #HP bar
  pygame.draw.rect(screen, (255, 0, 0), pygame.Rect((600, 15), (510, 60)))
  pygame.draw.rect(screen, (0, 0, 0), pygame.Rect((605, 20), (500, 50)))
  pygame.draw.rect(
      screen, (255, 255, 255),
      pygame.Rect((605 - (5 * player_2.hp - 500), 20), (5 * player_2.hp, 50)))
  #ULTIMATE bar
  pygame.draw.rect(screen, (255, 0, 0), pygame.Rect((600, 95), (510, 30)))
  pygame.draw.rect(screen, (0, 0, 0), pygame.Rect((605, 100), (500, 20)))
  pygame.draw.rect(
      screen, (255, 255, 255),
      pygame.Rect((605 - (5 * player_2.ult_meter - 500), 100),
                  (5 * player_2.ult_meter, 20)))


def draw_player_color(screen, player):
  player_colour = pygame.draw.rect(
      screen, (0, 0, 255) if player.player == 1 else (255, 0, 0),
      (player.rect.x, player.rect.y + 200, 200, 10))
  player_colour.center = (player.rect.midbottom)


def draw_player_shield(screen, player):
  if player.blocking:
    player_shield = pygame.draw.circle(
        screen, (56, 104, 217) if player.player == 1 else (204, 47, 47),
        (player.rect.centerx, player.rect.centery), player.block_hp)
  if player.block_break:
    player_shield = pygame.draw.circle(
        screen, (142, 142, 145), (player.rect.centerx, player.rect.centery),
        100)


def draw_ui():
  hp_bar()
  draw_player_color(screen, player_1)
  draw_player_color(screen, player_2)
  draw_player_shield(screen, player_1)
  draw_player_shield(screen, player_2)
...
def check_death():
  ...
  if player_1.hp <= 0 or player_2.hp <= 0:
    player_1.hp = 100
    player_2.hp = 100
    player_1.block_hp = 100
    player_2.block_hp = 100
    player_1.ult_meter = 0
    player_2.ult_meter = 0
...
while running:
  ...
  if game_active:
    ...
    # Apply camera offset to background
    ...
    #player_1_rect = pygame.draw.rect(screen,(0,255,0),player_1.rect,2)
    #player_2_rect = pygame.draw.rect(screen,(0,255,0),player_2.rect,2)
